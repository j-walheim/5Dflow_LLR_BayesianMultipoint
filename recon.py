...
if(os.path.exists(os.path.join(sys.path[0], "data.h5"))) == False:
...
results_v,results_std = BayesUnfold(I,kv_rec)
sio.savemat(os.path.join(sys.path[0],'bayes_res.mat'), {'results_v': results_v,'I': I,'results_std':results_std})
